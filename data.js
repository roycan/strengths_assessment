    ...
    const APP_KEY = 'scholars_compass_via_v1';
    const ADMIN_TOGGLE_KEY = 'scholars_compass_show_strengths';
    const ADMIN_SECRET = 'compass-debug';
    ...
    const STRENGTHS = [
      ...
      'Forgiveness','Humility','Prudence','Self-Regulation','Appreciation of Beauty',
      'Gratitude','Hope','Spirituality'
    ];
    // Note: 24 strengths listed above. (Counting: 23? Let's verify and add missing.)
    // We are missing one: There should be 24. Let's include 'Humor'.
    STRENGTHS.splice(19, 0, 'Humor'); // Insert Humor before Appreciation of Beauty

    // 96 pairs (A/B text + strength). Original, conversational.
    const QUESTIONS = [
      ...
      {id:44,aText:"I enjoy teaching others what I’ve learned.",aStrength:"Love of Learning",bText:"I can usually sense the mood of a group and adjust.",bStrength:"Social Intelligence"},
  ...
  {id:51,aText:"I try to forgive people so we can move forward.",aStrength:"Forgiveness",bText:"I feel anchored by a sense that my life ties into something larger.",bStrength:"Spirituality"},
  ...
  {id:54,aText:"I often use humor to lighten the mood in tough situations.",aStrength:"Humor",bText:"I map the upsides and downsides before I lock in a choice.",bStrength:"Judgment"},
  ...
  {id:58,aText:"I enjoy swapping insights about what I’ve recently learned.",aStrength:"Love of Learning",bText:"I adjust my tone as soon as I sense a shift in the room.",bStrength:"Social Intelligence"},
  ...
  {id:96,aText:"I organize people and resources to keep our plans moving.",aStrength:"Leadership",bText:"I invest time in making close relationships feel safe and valued.",bStrength:"Love"},
    ...
    // Ensure strengths appear exactly 8 times (optional quick check)
    function countStrengthAppearances() {
      const counts = {};
      STRENGTHS.forEach(s => counts[s] = 0);
      QUESTIONS.forEach(q => {
        counts[q.aStrength] = (counts[q.aStrength] || 0) + 1;
        counts[q.bStrength] = (counts[q.bStrength] || 0) + 1;
      });
      return counts;
    }